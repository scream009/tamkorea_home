...
const AdSettings = ({ ad }) => {
  ...
  const NUDGE = {
    ...
    // '이 설정값이 지금 왜 의미가 없는지'만 짚는다.
    no_balance: {
      pill: '확인 필요', cls: 'warn',
      title: '잔액이 소진되어 광고가 나가지 않았습니다',
      body: <>아래 설정은 그대로 살아 있습니다. 다만 잔액이 0이라 어제 집행이 없었고,
        그래서 소진률도 0%입니다. <b>설정을 바꿀 단계가 아니라 충전이 먼저</b>입니다.
        충전하시면 지금 설정 그대로 즉시 재개됩니다.</>,
    },
    low_balance: {
      pill: '확인 필요', cls: 'warn',
      title: '잔액이 곧 소진됩니다',
      body: <>지금 속도면 며칠 안에 광고가 멈춥니다. 멈추면 상권 노출 순위가 내려가고,
        다시 올리는 데 시간이 걸립니다. 소진 전에 충전을 권해 드립니다.</>,
    },
    // 잔액은 있는데 어제 집행이 0 — 예산이 남는 것과는 원인이 다르다.
    no_spend: {
      pill: '확인 필요', cls: 'info',
      title: '잔액은 있는데 어제 집행이 없었습니다',
      body: <>예산이 남아서가 아니라 광고가 <b>노출 자체를 못 했다</b>는 뜻입니다.
        노출 시간대에 상권 경쟁이 몰렸거나 단가가 밀렸을 수 있습니다.
